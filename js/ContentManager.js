...
ContentManager.prototype.loadGolemVisuals = function(golemType) {
	...
	return {
		...
		downSpecial: this.view.createBattleCharacterImage(path + 'block.png', 127),
		// downSpecialObject: this.view.createBattleCharacterImage(path + 'downSpecialObject.png', 127),
...
ContentManager.prototype.getBattleCharacterVisualsFromAsset = function(asset) {
	...
	return {
		...
		downSpecial: asset.downSpecial.cloneNode(true),
		// downSpecialObject: asset.downSpecialObject.cloneNode(true),
